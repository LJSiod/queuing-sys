...
<span class="small font-weight-bold">Total Accounts Overall:</span><span class="font-weight-bold small" style="float:right;"><?php echo number_format($row['totalaccounts'], 0) . '/' . number_format($row['paid'], 0); ?></span><br>
<span class="small font-weight-bold">Total Accounts Daily:</span><span class="font-weight-bold small" style="float:right;"><?php echo number_format($rowdaily['totalaccounts'], 0) . '/' . number_format($rowdaily['paid'], 0); ?></span>

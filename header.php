  ...
  <nav class="navbar navbar-expand-lg sticky-top bg-light navbar-light d-print-none">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <h6 class="mr-2 small">Current User: <b><?php echo htmlspecialchars($name); ?></b></h6>
        <img src="image/profile.png" style="width: 40px; height: 40px;" name="profile" class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton" style="z-index: 1000;">
          <div style="display: flex; align-items: center; justify-content: center;">
            <img src="image/Neologo.png" class="rounded-circle mt-3" alt="User Image" style="width: 70px; height: 70px;">
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="editprofile.php" id="editprofileform" method="post">
          ...
          <hr>
          <form action="editpassword.php" id="editpasswordform" method="post">

    ...
    <div class="br-pagebody">
        ...
        <input type="hidden" name="id" value="<?php echo $previewid; ?>">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control form-control-sm" id="clientname" value="<?php echo $row['clientname']; ?>" name="clientname" rows="1" required></input>
            </div>
            <div class="col-3">
                <label class="small" for="loanamount">Loan Amount</label>
                <input type="number" class="form-control form-control-sm" id="loanamount" value="<?php echo $row['loanamount']; ?>" name="loanamount" rows="1" required></input>
            </div>
            </div>
            <div class="row">
                <div class="col">
                    <label class="small" for="datereleased">Date Released</label>
                    <input type="date" class="form-control form-control-sm" id="datereleased" value="<?php echo $datereleased; ?>" name="datereleased" required>
                </div>
                <div class="col">
                    <label class="small" for="maturitydate">Maturity Date</label>
                    <input type="date" class="form-control form-control-sm" id="maturitydate" value="<?php echo $maturitydate; ?>" name="maturitydate" required>
                </div>
                <div class="col">
                    <label class="small" for="remainingbalance">Overall Remaining Balance</label>
                    <input type="number" class="form-control form-control-sm" id="remainingbalance" value="<?php echo $row['totalbalance']; ?>" name="remainingbalance" required>
                </div>
            </div>
            <div class="row">
            <div class="col">
                <label class="small" for="onhand">Client's On-Hand Cash</label>
                <input type="number" class="form-control form-control-sm" id="onhand" value="<?php echo $row['cashonhand']; ?>" name="onhand" rows="1" required></input>
            </div>
            <div class="col">
                <label class="small" for="contactno">Branch Active Contact No.</label>
                <input type="text" class="form-control form-control-sm" id="contactno" value="<?php echo $row['activenumber']; ?>" name="contactno" rows="1" required></input>
            </div>
            <div class="col">
                <label class="small" for="accinterest">Accrued Interest</label>
                <input type="text" class="form-control form-control-sm" id="accinterest" value="<?php echo $row['accinterest']; ?>" name="accinterest" rows="1" readonly></input>
            </div>
            <div class="col">
            ...
            <div class="col">
                ...
                <textarea class="form-control form-control-sm" id="remarks" name="remarks" rows="12" required><?php echo $row['remarks']; ?></textarea>
            </div>
            <div class="col">
                ...
                <label class="small form-control-label" for="ledger">Drag and drop files here<span class="text-danger ml-1" style="font-size: 0.6rem">*PDF/Image files accepted</span></label>
                    <img class="form-control form-control-sm fileThumbnail" id="thumbnail" src="<?php echo $row['attachname']; ?>" alt="File Thumbnail" ondrop="">
